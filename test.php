...
<html>
    ...
    <body>
        ...
        <?php else : ?>
            ...
            <h1>TAG</h1>
            <form method="GET" action="/rest/getalltags.php">
                <input type="submit" value="GET ALL TAGS">
            </form>

            <br/>

            <form method="POST" action="/rest/addtag.php">
            ...
            <form method="POST" action="/rest/deletetag.php">
            ...
            <form method="POST" action="/rest/edittag.php">
            ...
            <h1>CATEGORY</h1>
            <form method="GET" action="/rest/getcategories.php">
            ...
            <form enctype="multipart/form-data" method="POST" action="/rest/addcategory.php">
            ...
            <form method="POST" action="/rest/deletecategory.php">
            ...
            <form enctype="multipart/form-data" method="POST" action="/rest/editcategory.php">
            ...
            <h1>POST</h1>
            <form method="GET" action="/rest/getlatestpostsbycategory.php">
            ...
            <form method="GET" action="/rest/getpostbypermalink.php">
            ...
            <form method="GET" action="/rest/getpostsbytag.php">
            ...
            <form method="GET" action="/rest/getpostssummaries.php">
                <input type="number" name="offset" placeholder="offset">
            ...
            <form method="POST" action="/rest/addpost.php">
                <input type="text" name="title" placeholder="title">
            ...
            <form method="POST" action="/rest/deletepost.php">
            ...
            <form method="POST" action="/rest/editpost.php">
            ...
            <form method="POST" action="/rest/addrole.php">
            ...
            <form method="POST" action="/rest/deleterole.php">
            ...
            <form method="POST" action="/rest/editrole.php">
            ...
            <form method="POST" action="/rest/adduser.php">
                <input type="text" name="username" placeholder="username">
                <input type="password" name="password" placeholder="password">
                <input type="number" name="role" placeholder="role id">
            ...
            <form method="POST" action="/rest/deleteuser.php">
            ...
            <form method="POST" action="/rest/edituser.php">
            ...
            <h1>MESSAGES</h1>
            <form method="GET" action="/rest/getmessages.php">
                <input type="number" name="offset" placeholder="offset">
            ...
            <form method="POST" action="/rest/addmessage.php">
                <input type="text" name="title" placeholder="title">
            ...
            <form method="POST" action="/rest/deletemessage.php">
